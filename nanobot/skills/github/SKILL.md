---
name: github
description: "Interact with GitHub using the `gh` CLI. Use when users ask about issues, pull requests, workflow/CI runs, releases, repo metadata, or GitHub API queries."
